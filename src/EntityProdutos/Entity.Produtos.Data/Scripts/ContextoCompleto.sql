...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20231227233708_ContextoCompleto') THEN
...
BEGIN
    ...
    CREATE TABLE `fornecedores` (
        ...
        CONSTRAINT `FK_fornecedores_enderecos_EnderecoId` FOREIGN KEY (`EnderecoId`) REFERENCES `enderecos` (`Id`)
    ) CHARACTER SET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
BEGIN
    ...
    VALUES ('20231227233708_ContextoCompleto', '7.0.14');
