...
namespace Entity.Pedidos.Application.Commands
{
    ...
    {
        public CadastrarPedidoComando(string codigo, int clienteId, int enderecoId, 
        decimal desconto, decimal valorTotal, int? cupomDescontoId, PedidoStatus pedidoStatus)
        {
            Codigo = codigo;
            ClienteId = clienteId;
