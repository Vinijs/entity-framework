...
CREATE TABLE `cupons_descontos` (
    ...
    `codigo_cupom` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `pedidos` (
    ...
    CONSTRAINT `FK_pedidos_cupons_descontos_cupom_desconto_id` FOREIGN KEY (`cupom_desconto_id`) REFERENCES `cupons_descontos` (`cupom_desconto_id`),
