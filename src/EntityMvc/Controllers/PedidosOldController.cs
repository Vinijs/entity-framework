...
{
    public class PedidosOldController : Controller
    {
        private readonly PedidoDbContexto _context;

        public PedidosOldController(PedidoDbContexto context)
        {
            _context = context;
        }
        ...
        {
            var dbContexto = _context.Pedidos.Include(p => p.Endereco);
