...
namespace entity_framework.Controllers
{
    public class FornecedoresOldController : Controller
    {
        ...
        {
            var dbContexto = _context.Fornecedores.Include(p => p.Endereco);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var pedido = await _context.Fornecedores
                // .Include(p => p.Cliente)
        ...
        public void EstadosEntidades()
        {
            ...
            //Verificando se alguma entidade do contexto tem mudanças
            var temMudancasOContexto = _context.ChangeTracker.HasChanges();

            _context.Database.AutoTransactionsEnabled = false;

            //Buscar valores originais de quando a quantidade foi inicialmente gerada no  contexto
